...
public class RedstoneArmour extends ItemArmor {
	
	public RedstoneArmour(ArmorMaterial material, int renderIndex, EntityEquipmentSlot equipmentSlotIn) {
    ...
    {
        ItemStack mat = new ItemStack(TechItems.redstone_ingot);
    ...
    {
		list.add(TextFormatting.YELLOW + new TextComponentTranslation("tooltip.redstonearmor_1").getFormattedText());
    }
}