...
public class IronCobblegen extends Block implements ITileEntityProvider{
    ...
    {
		list.add(TextFormatting.YELLOW + new TextComponentTranslation("tooltip.ironcobblegen_1").getFormattedText());
		list.add(TextFormatting.YELLOW + new TextComponentTranslation("tooltip.ironcobblegen_2").getFormattedText());
		list.add(TextFormatting.YELLOW + new TextComponentTranslation("tooltip.ironcobblegen_3").getFormattedText());
		list.add(TextFormatting.YELLOW + new TextComponentTranslation("tooltip.ironcobblegen_4").getFormattedText());
    }
