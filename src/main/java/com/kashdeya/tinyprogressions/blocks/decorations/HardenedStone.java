...
public class HardenedStone extends Block {
	
	public HardenedStone()
    {
        super(Material.ROCK);
        ...
        this.setUnlocalizedName("hardened_stone");
    }
    ...
    {
        return Item.getItemFromBlock(TechBlocks.hardened_stone);
    }
    ...
    public boolean canEntityDestroy(IBlockState state, IBlockAccess world, BlockPos pos, Entity entity)
    {
        ...
        {
            return this != TechBlocks.hardened_stone;
        }
