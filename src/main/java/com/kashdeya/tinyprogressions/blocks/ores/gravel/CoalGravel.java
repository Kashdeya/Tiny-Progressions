...
public class CoalGravel extends BlockFalling {
	
	public CoalGravel()
    {
        this.setSoundType(blockSoundType.GROUND);
        this.setCreativeTab(tinyprogressions.tabTP);
        this.setUnlocalizedName("coal_gravel");
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune)
    {
        ...
        return rand.nextInt(10 - fortune * 3) == 0 ? Items.COAL : Item.getItemFromBlock(this);
    }
