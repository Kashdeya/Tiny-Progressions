...
public class DiamondGravel extends BlockFalling {
	
	public DiamondGravel()
    {
        this.setSoundType(blockSoundType.GROUND);
        this.setCreativeTab(tinyprogressions.tabTP);
        this.setUnlocalizedName("diamond_gravel");
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune)
    {
        ...
        return rand.nextInt(10 - fortune * 3) == 0 ? Items.DIAMOND : Item.getItemFromBlock(this);
    }
