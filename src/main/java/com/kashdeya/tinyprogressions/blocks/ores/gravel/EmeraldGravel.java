...
public class EmeraldGravel extends BlockFalling {
	
	public EmeraldGravel()
    {
        this.setSoundType(blockSoundType.GROUND);
        this.setCreativeTab(tinyprogressions.tabTP);
        this.setUnlocalizedName("emerald_gravel");
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune)
    {
        ...
        return rand.nextInt(10 - fortune * 3) == 0 ? Items.EMERALD : Item.getItemFromBlock(this);
    }
