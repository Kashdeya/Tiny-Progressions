...
public class QuartzGravel extends BlockFalling  {
	
	public QuartzGravel()
    {
        this.setSoundType(blockSoundType.GROUND);
        this.setCreativeTab(tinyprogressions.tabTP);
        this.setUnlocalizedName("quartz_gravel");
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune)
    {
        ...
        return rand.nextInt(10 - fortune * 3) == 0 ? Items.QUARTZ : Item.getItemFromBlock(this);
    }
