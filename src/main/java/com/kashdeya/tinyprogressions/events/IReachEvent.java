	    ...
	    if (mc.world != null)
	    {
	      ...
	      for (Entity entity : list) {
	        if (entity.canBeCollidedWith())
	        {
	          ...
	          AxisAlignedBB aabb = new AxisAlignedBB(entity.posX - entity.posX / 2.0F, entity.posY, entity.posZ - entity.posX / 2.0F, entity.posX + entity.posX / 2.0F, entity.posY + entity.height, entity.posZ + entity.posX / 2.0F);
