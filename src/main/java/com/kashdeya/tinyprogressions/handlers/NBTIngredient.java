...
public class NBTIngredient extends Ingredient {
	...
	public NBTIngredient(final ItemStack... stacks) {
		super(0);
	...
	public boolean apply(@Nullable final ItemStack stackToCheck) {
		...
		for (final ItemStack stack : matchingStacks) {
			if (stack.getItem() == stackToCheck.getItem()) {
				...
				if ((metadata == OreDictionary.WILDCARD_VALUE || (ItemStack.areItemsEqual(stackToCheck, stack) && ItemStack.areItemStacksEqualUsingNBTShareTag(stackToCheck, stack)))) {
					return true;
				}
			}
		}
