...
public enum ArmorMaterialTier implements IArmorMaterial{
	...
	STONE   ("stone"   , 15 ,  new int[]{1, 3, 3, 2}  , 10,  SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0.05F, () -> { return Ingredient.fromItems(Blocks.STONE); }),
	FLINT   ("flint"   , 12 ,  new int[]{1, 3, 3, 1}  , 10,  SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0.01F, () -> { return Ingredient.fromItems(Items.FLINT);  }),
	BONE    ("bone"    , 8  ,  new int[]{1, 3, 2, 1}  , 8 ,  SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0.02F, () -> { return Ingredient.fromItems(Items.BONE); }),
	WOOD    ("wood"    , 5  ,  new int[]{1, 2, 1, 1}  , 5 ,  SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0.01F, () -> { return Ingredient.fromItems(Items.ACACIA_WOOD, Items.BIRCH_WOOD, Items.DARK_OAK_WOOD, Items.JUNGLE_WOOD, Items.OAK_WOOD, Items.SPRUCE_WOOD); }),
	...
	LAPIS   ("lapis"   , 20 ,  new int[]{1, 4, 5, 3}  , 20,  SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 1.5F,  () -> { return Ingredient.fromItems(Items.LAPIS_LAZULI); }),
