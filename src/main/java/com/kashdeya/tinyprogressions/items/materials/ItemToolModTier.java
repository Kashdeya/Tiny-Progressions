...
public enum ItemToolModTier implements IItemTier
{
	...
	WUBWUB     (4, 3261,  12.0F,  7.0F,  22,() -> { return Ingredient.fromItems(Items.AIR); }),
	//Paxels
	...
	POBSIDIAN  (4, 3000, 9.0F, 11.0F, 10,() -> { return Ingredient.fromItems(Items.OBSIDIAN); }),
	...
	PWUBWUB    (4, 4250, 12.0F, 14.0F, 22,() -> { return Ingredient.fromItems(Items.AIR); }),
	//SeaAxe
	SEAIRON    (3, 2750, 10.0F, 10.0F, 22,() -> { return Ingredient.fromItems(Items.AIR); });
