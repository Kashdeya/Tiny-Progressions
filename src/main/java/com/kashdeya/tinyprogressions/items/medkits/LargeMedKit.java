...
public class LargeMedKit extends Item {
	...
	protected void onItemUse(ItemStack stack, World worldIn, EntityPlayer player) {
		if (player.getHealth() < player.getMaxHealth()){
			...
			player.addPotionEffect(new PotionEffect(MobEffects.HEALTH_BOOST, ConfigHandler.largeMedBoostTime * 20, 2, false, false));
		}
	...
	public void addInformation(ItemStack stack, World player, List<String> tooltip, ITooltipFlag advanced) {
		...
		tooltip.add(TextFormatting.YELLOW + new TextComponentTranslation("tooltip.largemedkit_2").getFormattedText());
