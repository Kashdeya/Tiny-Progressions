...
public class Recipes {
	...
	public static void registerRecipes(){
		...
		if (ConfigHandler.obsidian_scythe){
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TechTools.obsidian_scythe), "ddd", " s ", "s  ", 'd', "ingotObsidian", 's', "stickWood"));
		}
		...
		if (ConfigHandler.obsidian_battle){
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TechTools.obsidian_battle), "dsd", "dsd", " s ", 'd', "ingotObsidian", 's', "stickWood"));
		}
		...
		if (ConfigHandler.obsidian_spear){
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TechTools.obsidian_spear), "d  ", " s ", "  s", 'd', "ingotObsidian", 's', "stickWood"));
		}
		...
		if (ConfigHandler.obsidian_axe){
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TechTools.obsidian_axe), "ff ", "fs ", " s ", 'f', "ingotObsidian", 's', "stickWood"));
		}
		if (ConfigHandler.obsidian_hoe){
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TechTools.obsidian_hoe), "ff ", " s ", " s ", 'f', "ingotObsidian", 's', "stickWood"));
		}
		if (ConfigHandler.obsidian_sword){
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TechTools.obsidian_sword), "f", "f", "s", 'f', "ingotObsidian", 's', "stickWood"));
		}
		if (ConfigHandler.obsidian_spade){
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TechTools.obsidian_spade), "f", "s", "s", 'f', "ingotObsidian", 's', "stickWood"));
		}
		if (ConfigHandler.obsidian_pickaxe){
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TechTools.obsidian_pickaxe), "fff", " s ", " s ", 'f', "ingotObsidian", 's', "stickWood"));
		}
