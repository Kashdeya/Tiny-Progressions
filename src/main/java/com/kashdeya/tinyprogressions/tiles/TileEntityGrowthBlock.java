...
public class TileEntityGrowthBlock extends TileEntity implements ITickableTileEntity//ISidedInventory,
{
	...
	public TileEntityGrowthBlock setGenStats(int cycleUpdate, int maxStackSize) {
	...
	public static ItemStack putStackInInventoryAllSlots(IInventory inventoryIn, ItemStack stack,
		...
		if (inventoryIn instanceof ISidedInventory && side != null && !(inventoryIn instanceof TileEntityGrowthBlock) && inventoryIn.isItemValidForSlot(0, stack.copy())) {
			ISidedInventory isidedinventory = (ISidedInventory) inventoryIn;
			int[] aint = isidedinventory.getSlotsForFace(side);
